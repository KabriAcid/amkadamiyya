<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 pt-1 fixed-start ms-3 " id="sidenav-main">
   ...
   <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
         <!-- Dashboard -->
         <li class="nav-item">
            <a data-bs-toggle="collapse" href="#dashboarMenu" class="nav-link 
               <?php
               ...
               ?>" aria-controls="dashboarMenu" role="button" aria-expanded="false">
            ...
            <div class="collapse " id="dashboarMenu">
         ...
         <!-- Defaults -->
         <li class="nav-item">
            <a href="admin-set-defaults.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'admin-set-defaults.php' ? 'active' : '' ?>">
               <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                  <i class="ni ni-settings-gear-65 
                  <?php
                  if (basename($_SERVER['PHP_SELF']) == 'admin-set-defaults.php' || basename($_SERVER['PHP_SELF']) == 'admin-set-defaults.php') {
                     echo 'text-white';
                  } else {
                     echo 'text-dark';
                  }
               ...
               <span class="nav-link-text ms-1">Defaults</span>
            </a>
         </li>
         <!-- Line Breaker -->
         <li class="nav-item">
