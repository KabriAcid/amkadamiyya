...
<head>
    ...
    <link rel="stylesheet" href="../../css/soft-ui-dashboard.min3f71.css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                            <div class="card z-index-0 mt-8 mb-3">
                                    ...
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            <input type="text" class="form-control"
                                                placeholder="Username" name="username" tabindex="1">
                                        </div>
                                        <div class="mb-3">
                                            <input type="password" class="form-control"
                                                placeholder="Password" id="password" name="password"  tabindex="2">
                                            <small id="text" class="text-danger text-center mt-2"></small>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input mt-1" type="checkbox" id="showPassword"
                                                onchange="togglePasswordVisibility()" tabindex="3">
                                ...
                                <div class="card-footer text-center pt-0 px-sm-4 px-1">
                                    ...
                                    <p class="mb-0 mt-3 text-sm mx-auto">
                                        <a href="../../index.php" class="text-dark text-gradient font-weight-bold">Back
                                            to Homepage</a>
                                    </p>
                                </div>
                            </div>
