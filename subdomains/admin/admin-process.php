...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $mandatoryFields = ['first_name', 'last_name', 'birth_date', 'gender', 'address', 'state', 'lga', 'email', 'qualification', 'discipline', 'class_id', 'subject_id', 'section_id', 'account_number', 'bank_name', 'salary', 'status', 'position_id'];
