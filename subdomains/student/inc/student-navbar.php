            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    ...
                    <a href="admin-profile.php" class="nav-link text-body font-weight-bold px-0">
                        <span class="me-2"><small class="text-secondary">Hi&comma;&nbsp;</small><span class="font-weight-bolder"><?php echo $_SESSION['student']['first_name'] . '&nbsp;' . $_SESSION['student']['last_name']; ?></span></span>
                    </a>
                </li>
