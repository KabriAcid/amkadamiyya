...
if (isset($_SESSION['student'])) {
    ...
    $upload = mysqli_fetch_assoc($uploads);
    ...
    // Retrieve section from session section
        ...
        <div class="container-fluid pt-3">
                ...
                <div class="info-box">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8">
                            ...
                            <span class="font-weight-bold"><?php echo $student['first_name'] . " " . $student['second_name'] . " " . $student['last_name']; ?></span>
                        </div>
                        <div class="col-md-4 col-sm-4 text-end">
                            <span class="text-secondary">Position:&nbsp;</span><span class="font-weight-bold"><?php echo addOrdinalSuffix($upload['position']); ?></span>
                        </div>
                    </div>
                    <!-- Row II -->
                    <div class="row">
                        <div class="col-md-4 col-sm-4 py-1 text-left">
                            <span class="text-secondary">Gender:&nbsp;</span><span class="font-weight-bold"><?php echo $student['gender']; ?></span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 py-1 text-left">
                            <span class="text-secondary">State:&nbsp;</span><span class="font-weight-bold"><?php echo $student['state']; ?></span>
                        </div>
                        <div class="col-md-4 col-sm-4 py-1 text-center">
                            <span class="text-secondary">LGA:&nbsp;</span><span class="font-weight-bold"><?php echo $student['lga']; ?></span>
                        </div>
                        <div class="col-md-4 col-sm-4 py-1 text-end">
                            <span class="text-secondary">Term:&nbsp;</span><span class="font-weight-bold"><?php echo $default['current_term']; ?></span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 py-1 text-left">
                            <span class="text-secondary">Session:&nbsp;</span><span class="font-weight-bold"><?php echo $default['session_name']; ?></span>
                        </div>
                        <div class="col-md-4 col-sm-4 py-1 text-center">
                            <span class="text-secondary">Term Ended:&nbsp;</span><span class="font-weight-bold"><?php echo $default['term_ending']; ?></span>
                        </div>
                        <div class="col-md-4 col-sm-4 py-1 text-end">
                            <span class="text-secondary">Next Term Begins:&nbsp;</span><span class="font-weight-bold"><?php echo $default['term_begins']; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <table class="table table-responsive ">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" class="text-end font-weight-bolder border">Grand Total: <?php echo $upload['grand_total']; ?></td>
                        </tr>
                        <tr>
                            <td colspan="6" class="text-end font-weight-bolder border">Average:
                                <?php echo $upload['average']; ?>
                            </td>
                        </tr>
                    </tfoot>
                </table>
